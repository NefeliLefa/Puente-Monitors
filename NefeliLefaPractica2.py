...
class Monitor():
    ...
    def are_nobody1(self):
        return self.nhumans.value == 0 and \
            ...
            (self.turn.value == 1 or self.nhumans_waiting.value == 0 or self.ncars2_waiting.value == 0)
    
    def are_nobody2(self):
        return self.nhumans.value == 0 and \
            self.ncars1.value == 0  and \
            (self.turn.value == 2 or self.nhumans_waiting.value == 0 or self.ncars1_waiting.value == 0)
